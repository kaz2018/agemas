    ...
    <div class="space-y-6">
      <div class="rounded-2xl border border-amber-100 bg-white p-8 shadow-sm">
        ...
        <p class="leading-8 text-gray-600">
          子ども服や育児グッズのおさがりをお知らせする掲示板です。<br />
          着れなくなってしまった子供服や遊び飽きてしまったおもちゃなど、捨てるのももったいないし、もらってくれる人を見つけるのも面倒です。このサービスでは、なるべく処分の手間もかけず、お金をかけずに子育てできる仕組みを目指しています。
        </p>
      </div>
      ...
      <div class="rounded-2xl border border-amber-100 bg-white p-8 shadow-sm">
        ...
        <p class="leading-8 text-gray-600">
          おさがりのやり取りをきっかけに、麻績村・筑北村のママさんたちが気軽にやり取りできるきっかけを増やしたいと思っています。<br
          />
          子育て中は孤独な気持ちになることも多いと聞きます。村外から引っ越してきた方や、会社勤めが忙しくてこれまで地元でのコミュニケーションがなかなかできなかった方も、気軽にお話しできるといいと思っています。
        </p>
      </div>
    </div>
  </main>
