...
console.log("Login name:", `${LAST_NAME} ${FIRST_NAME}`);
console.log("");
...
await testWs(
  "B: /rpc なし + NS/DB in connect + variables",
  {
...
await testWs(
  "C: /rpc あり + NS/DB in connect + variables",
  {
    rpc: true,
    init: { namespace: NS, database: DB },
  },
...
await testWs(
  "D: 接続オプションなし + signin で NS/DB + variables",
  {
    init: {},
  },
  {
